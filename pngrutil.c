...
png_uint_32
png_get_uint_31(png_const_structrp png_ptr, const png_byte *buf)
{
...
void /* PRIVATE */
png_crc_read(png_structrp png_ptr, png_byte *buf, png_uint_32 length)
{
   if (png_ptr == NULL)
      return;
 ...
 */
static int
png_inflate_read(png_structrp png_ptr, png_byte *read_buffer, uInt read_size,
...
png_handle_pCAL(png_structrp png_ptr, png_inforp info_ptr, png_uint_32 length)
{
   ...
   png_byte *buffer, *buf, *units, *endptr;
   char **params;
   int i;
 ...
 */
void /* PRIVATE */
png_combine_row(png_const_structrp png_ptr, png_byte *dp, int display)
{
...
#ifdef PNG_READ_INTERLACING_SUPPORTED
void /* PRIVATE */
png_do_read_interlace(png_row_infop row_info, png_byte *row, int pass,
...
static void
png_read_filter_row_sub(png_row_infop row_info, png_byte *row,
...
static void
png_read_filter_row_up(png_row_infop row_info, png_byte *row,
    const png_byte *prev_row)
{
   size_t i;
   size_t istop = row_info->rowbytes;
...
static void
png_read_filter_row_avg(png_row_infop row_info, png_byte *row,
    const png_byte *prev_row)
{
   size_t i;
   png_byte *rp = row;
...
static void
png_read_filter_row_paeth_1byte_pixel(png_row_infop row_info, png_byte *row,
    const png_byte *prev_row)
{
...
static void
png_read_filter_row_paeth_multibyte_pixel(png_row_infop row_info, png_byte *row,
    const png_byte *prev_row)
{
   unsigned int bpp = (row_info->pixel_depth + 7) >> 3;
...
void /* PRIVATE */
png_read_filter_row(png_structrp pp, png_row_infop row_info, png_byte *row,
...
void /* PRIVATE */
png_read_IDAT_data(png_structrp png_ptr, png_byte *output,
