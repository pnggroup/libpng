...
void
png_push_fill_buffer(png_structp png_ptr, png_byte *buffer, size_t length)
{
   png_byte *ptr;
...
void /* PRIVATE */
png_push_restore_buffer(png_structrp png_ptr, png_byte *buffer,
...
void /* PRIVATE */
png_process_IDAT_data(png_structrp png_ptr, png_byte *buffer,
    size_t buffer_length)
{
...
void /* PRIVATE */
png_push_have_row(png_structrp png_ptr, png_byte *row)
{
...
#ifdef PNG_READ_INTERLACING_SUPPORTED
void
png_progressive_combine_row(png_const_structrp png_ptr, png_byte *old_row,
...
void
png_set_progressive_read_fn(png_structrp png_ptr, void *progressive_ptr,
