README for libpng 1.0.10 - March 30, 2001 (shared library 2.1)
...
Files in this distribution:
      ...
      scripts       =>  Directory containing scripts for building libpng:
       ...
       makefile.linux   =>  Linux/ELF makefile
                            (gcc, creates libpng.so.2.1.0.10)
       makefile.gcmmx   =>  Linux/ELF makefile (gcc, creates
                            libpng.so.2.1.0.10, uses assembler code
       ...
       makefile.sggcc   =>  Silicon Graphics (gcc, creates libpng.so.2.1.0.10)
