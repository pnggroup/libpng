 ...
 */
#define context(ps,fault) struct exception_context *the_exception_context = \
   &(ps)->exception_context; png_store *fault
   ...
   PNG_CONST char * volatile name)
{
   ...
   Try
   {
      ...
      ps->pwrite = png_create_write_struct(PNG_LIBPNG_VER_STRING, ps,
